"""Redis Cloud's API, over the proxy, holding no credential.
...
Redis Cloud's authentication changed tomorrow, because the authentication is
...
from integrations.redis.schema import INTEGRATION, base_url

PING_PATH: Final = "/v1/subscriptions"
LIST_SESSIONS_PATH: Final = "/v1/subscriptions"
SLOW_QUERIES_PATH: Final = "/v1/subscriptions"
...
class RedisClient(IntegrationClient):
    """Redis Cloud, reached through the credential proxy."""
    ...
    async def list_sessions(
        ...
        *,
        ...
        """Return what Redis Cloud holds for this request, bounded.
        ...
        """
        # Redis Cloud narrows this endpoint by other means; the argument stays in the
        ...
        async def fetch(parameters: Mapping[str, str]) -> Page[dict[str, Any]]:
            ...
            return Page(items=records(answer, "subscriptions"), cursor="" or None)
    ...
    async def ping(self) -> ClientResponse:
        """Make the cheapest authenticated call Redis Cloud offers.
