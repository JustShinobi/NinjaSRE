"""RabbitMQ: RabbitMQ's management API: which queues exist and how deep they are, which is the first question of every message-backlog incident.
...
from integrations.rabbitmq.client import PAGINATION, RabbitmqClient
from integrations.rabbitmq.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.rabbitmq.verifier import PERMISSIONS, RabbitmqVerifier
