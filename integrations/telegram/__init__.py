"""Telegram: A Telegram chat used as an alerting channel: what has arrived recently, and a finding delivered into it.
...
from integrations.telegram.client import PAGINATION, TelegramClient
from integrations.telegram.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.telegram.verifier import PERMISSIONS, TelegramVerifier
