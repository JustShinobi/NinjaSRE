"""Spark: Spark's history and status API: which applications and jobs are in which state, and the ones that failed.
...
from integrations.spark.client import PAGINATION, SparkClient
from integrations.spark.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.spark.verifier import PERMISSIONS, SparkVerifier
