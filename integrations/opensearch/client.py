"""OpenSearch's API, over the proxy, holding no credential.
...
OpenSearch's authentication changed tomorrow, because the authentication is
...
from integrations.opensearch.schema import INTEGRATION, base_url
...
class OpensearchClient(IntegrationClient):
    """OpenSearch, reached through the credential proxy."""
    ...
    async def search_logs(
        ...
        *,
        ...
        """Return what OpenSearch holds for this request, bounded.
        ...
        """
        # OpenSearch narrows this endpoint by other means; the argument stays in the
    ...
    async def ping(self) -> ClientResponse:
        """Make the cheapest authenticated call OpenSearch offers.
