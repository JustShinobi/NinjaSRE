"""OpenSearch: Search over OpenSearch indices, counted by field before any document is read, for the deployments whose logs live in the fork rather than in Elasticsearch.
...
from integrations.opensearch.client import PAGINATION, OpensearchClient
from integrations.opensearch.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.opensearch.verifier import PERMISSIONS, OpensearchVerifier
...
PROFILE: Final = IntegrationProfile(
    ...
    summary="Search over OpenSearch indices, counted by field before any document is read, for the deployments whose logs live in the fork rather than in Elasticsearch.",
    regions=REGIONS,
