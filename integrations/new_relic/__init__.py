"""New Relic: NRQL over New Relic's telemetry, and the alert violations currently open, for the accounts whose metrics and events live there.
...
from integrations.new_relic.client import PAGINATION, NewRelicClient
from integrations.new_relic.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.new_relic.verifier import PERMISSIONS, NewRelicVerifier
...
DESCRIPTOR: Final = IntegrationDescriptor(
    ...
    schema=SCHEMA,
    rule=RULE,
    verifier=NewRelicVerifier(),
    client_class=NewRelicClient,
