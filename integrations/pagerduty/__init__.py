"""PagerDuty: Who is being paged and for what: the incidents PagerDuty is holding, one incident's log, and the acknowledgement that stops the escalation clock.
...
from integrations.pagerduty.client import PAGINATION, PagerdutyClient
from integrations.pagerduty.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.pagerduty.verifier import PERMISSIONS, PagerdutyVerifier
...
PROFILE: Final = IntegrationProfile(
    ...
    summary="Who is being paged and for what: the incidents PagerDuty is holding, one incident's log, and the acknowledgement that stops the escalation clock.",
    regions=REGIONS,
