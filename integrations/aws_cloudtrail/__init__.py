"""AWS CloudTrail: Who changed what in this AWS account, and when. The change history most incidents turn out to need and most investigations reach for too late.
...
from integrations.aws_cloudtrail.client import PAGINATION, AwsCloudtrailClient
from integrations.aws_cloudtrail.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.aws_cloudtrail.verifier import PERMISSIONS, AwsCloudtrailVerifier
...
DESCRIPTOR: Final = IntegrationDescriptor(
    ...
    schema=SCHEMA,
    rule=RULE,
    verifier=AwsCloudtrailVerifier(),
    client_class=AwsCloudtrailClient,
