"""Blameless: Blameless's incident record: what is open, one incident's events, and the update that says an automated investigation is under way.
...
from integrations.blameless.client import PAGINATION, BlamelessClient
from integrations.blameless.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.blameless.verifier import PERMISSIONS, BlamelessVerifier
...
DESCRIPTOR: Final = IntegrationDescriptor(
    ...
    schema=SCHEMA,
    rule=RULE,
    verifier=BlamelessVerifier(),
    client_class=BlamelessClient,
