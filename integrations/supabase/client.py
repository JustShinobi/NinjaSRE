"""Supabase's API, over the proxy, holding no credential.
...
Supabase's authentication changed tomorrow, because the authentication is
...
from integrations.supabase.schema import INTEGRATION, base_url

PING_PATH: Final = "/v1/organizations"
LIST_SESSIONS_PATH: Final = "/v1/projects"
SLOW_QUERIES_PATH: Final = "/v1/projects"
...
class SupabaseClient(IntegrationClient):
    """Supabase, reached through the credential proxy."""
    ...
    async def list_sessions(
        ...
        *,
        ...
        """Return what Supabase holds for this request, bounded.
        ...
        """
        # Supabase narrows this endpoint by other means; the argument stays in the
    ...
    async def ping(self) -> ClientResponse:
        """Make the cheapest authenticated call Supabase offers.
