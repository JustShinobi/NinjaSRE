"""Supabase's credential shape, hosts, and how its secret enters a request.
...
INTEGRATION: Final = "supabase"


#: Every host Supabase serves its API from. Exact names, no wildcards.
REGIONS: Final = RegionMap.single(INTEGRATION, host="api.supabase.com", name="global")
...
SCHEMA: Final = credential_schema(
    INTEGRATION,
    secret("token", "Supabase management API personal access token", min_length=8),
    public("organisation", "Supabase organisation slug"),
)
