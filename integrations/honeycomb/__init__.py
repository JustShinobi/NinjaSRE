"""Honeycomb: Honeycomb's query engine over trace events: where latency and errors concentrate in a dataset, and the slowest traces behind that concentration.
...
from integrations.honeycomb.client import PAGINATION, HoneycombClient
from integrations.honeycomb.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.honeycomb.verifier import PERMISSIONS, HoneycombVerifier
...
DESCRIPTOR: Final = IntegrationDescriptor(
    ...
    schema=SCHEMA,
    rule=RULE,
    verifier=HoneycombVerifier(),
    client_class=HoneycombClient,
...
PROFILE: Final = IntegrationProfile(
    ...
    summary="Honeycomb's query engine over trace events: where latency and errors concentrate in a dataset, and the slowest traces behind that concentration.",
    regions=REGIONS,
