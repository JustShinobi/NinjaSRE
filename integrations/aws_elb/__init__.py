"""AWS ELB: Elastic Load Balancing state: which load balancers exist and in what state, and the target groups behind them.
...
from integrations.aws_elb.client import PAGINATION, AwsElbClient
from integrations.aws_elb.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.aws_elb.verifier import PERMISSIONS, AwsElbVerifier
...
DESCRIPTOR: Final = IntegrationDescriptor(
    ...
    schema=SCHEMA,
    rule=RULE,
    verifier=AwsElbVerifier(),
    client_class=AwsElbClient,
