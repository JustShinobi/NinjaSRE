"""Prefect's API, over the proxy, holding no credential.
...
Prefect's authentication changed tomorrow, because the authentication is
...
from integrations.prefect.schema import INTEGRATION, base_url

PING_PATH: Final = "/api/health"
LIST_TASKS_PATH: Final = "/api/flow_runs/filter"
LIST_FAILURES_PATH: Final = "/api/flow_runs/filter"
...
class PrefectClient(IntegrationClient):
    """Prefect, reached through the credential proxy."""
    ...
    async def list_tasks(
        ...
        *,
        ...
        """Return what Prefect holds for this request, bounded.
        ...
        """
        # Prefect narrows this endpoint by other means; the argument stays in the
    ...
    async def ping(self) -> ClientResponse:
        """Make the cheapest authenticated call Prefect offers.
