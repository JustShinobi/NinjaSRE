"""Trello: What a Trello board is holding: the cards on it, which list each is in, and which were touched most recently.
...
from integrations.trello.client import PAGINATION, TrelloClient
from integrations.trello.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.trello.verifier import PERMISSIONS, TrelloVerifier
...
DESCRIPTOR: Final = IntegrationDescriptor(
    ...
    schema=SCHEMA,
    rule=RULE,
    verifier=TrelloVerifier(),
    client_class=TrelloClient,
