"""VictoriaMetrics: MetricsQL against VictoriaMetrics and the alerts vmalert is holding, for the estates that use it as a long-term Prometheus store.
...
from integrations.victoriametrics.client import PAGINATION, VictoriametricsClient
from integrations.victoriametrics.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.victoriametrics.verifier import PERMISSIONS, VictoriametricsVerifier
...
DESCRIPTOR: Final = IntegrationDescriptor(
    ...
    schema=SCHEMA,
    rule=RULE,
    verifier=VictoriametricsVerifier(),
    client_class=VictoriametricsClient,
...
PROFILE: Final = IntegrationProfile(
    ...
    summary="MetricsQL against VictoriaMetrics and the alerts vmalert is holding, for the estates that use it as a long-term Prometheus store.",
    regions=REGIONS,
