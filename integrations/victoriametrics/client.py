"""VictoriaMetrics's API, over the proxy, holding no credential.
...
VictoriaMetrics's authentication changed tomorrow, because the authentication is
...
from integrations.victoriametrics.schema import INTEGRATION, base_url
...
class VictoriametricsClient(IntegrationClient):
    """VictoriaMetrics, reached through the credential proxy."""
    ...
    async def query_metric(
        ...
        *,
        ...
        """Return what VictoriaMetrics holds for this request, bounded.
    ...
    async def list_alerts(
        ...
        *,
        ...
        "there is no more" when what happened was "we stopped looking".
        """
        # VictoriaMetrics narrows this endpoint by other means; the argument stays in the
    ...
    async def ping(self) -> ClientResponse:
        """Make the cheapest authenticated call VictoriaMetrics offers.
