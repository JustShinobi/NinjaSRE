"""MongoDB Atlas: The Atlas control plane: which clusters and processes exist in a project, and the slow-query entries Atlas's performance advisor has collected.
...
from integrations.mongodb_atlas.client import PAGINATION, MongodbAtlasClient
from integrations.mongodb_atlas.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.mongodb_atlas.verifier import PERMISSIONS, MongodbAtlasVerifier
...
DESCRIPTOR: Final = IntegrationDescriptor(
    ...
    schema=SCHEMA,
    rule=RULE,
    verifier=MongodbAtlasVerifier(),
    client_class=MongodbAtlasClient,
