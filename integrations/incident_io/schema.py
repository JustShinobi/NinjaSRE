"""incident.io's credential shape, hosts, and how its secret enters a request.
...
INTEGRATION: Final = "incident_io"


#: Every host incident.io serves its API from. Exact names, no wildcards.
REGIONS: Final = RegionMap.single(INTEGRATION, host="api.incident.io", name="global")
...
SCHEMA: Final = credential_schema(
    INTEGRATION,
    secret("token", "incident.io API key with incident read and write scopes", min_length=8),
)
