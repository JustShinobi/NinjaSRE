"""Better Stack: Better Stack's log search and the monitors it is currently reporting as down, for teams using it as both log store and uptime checker.
...
from integrations.better_stack.client import PAGINATION, BetterStackClient
from integrations.better_stack.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.better_stack.verifier import PERMISSIONS, BetterStackVerifier
...
DESCRIPTOR: Final = IntegrationDescriptor(
    ...
    schema=SCHEMA,
    rule=RULE,
    verifier=BetterStackVerifier(),
    client_class=BetterStackClient,
