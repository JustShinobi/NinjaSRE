"""Better Stack's credential shape, hosts, and how its secret enters a request.
...
INTEGRATION: Final = "better_stack"


#: Every host Better Stack serves its API from. Exact names, no wildcards.
REGIONS: Final = RegionMap.single(INTEGRATION, host="telemetry.betterstack.com", name="global")
...
SCHEMA: Final = credential_schema(
    INTEGRATION,
    secret("token", "Better Stack API token, from the team whose sources you query", min_length=8),
)
