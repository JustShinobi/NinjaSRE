"""Azure's API, over the proxy, holding no credential.
...
Azure's authentication changed tomorrow, because the authentication is
...
from integrations.azure.schema import INTEGRATION, base_url

PING_PATH: Final = "/subscriptions/{subscription}/resources"
LIST_RESOURCES_PATH: Final = "/subscriptions/{subscription}/resources"
LIST_CHANGES_PATH: Final = (
    "/subscriptions/{subscription}/providers/microsoft.insights/eventtypes/management/values"
)
...
class AzureClient(IntegrationClient):
    """Azure, reached through the credential proxy."""
    ...
    async def list_resources(
        ...
        *,
        ...
        """Return what Azure holds for this request, bounded.
        ...
        """
        # Azure narrows this endpoint by other means; the argument stays in the
        ...
        async def fetch(parameters: Mapping[str, str]) -> Page[dict[str, Any]]:
            asked: dict[str, str] = {"api-version": "2021-04-01", "$filter": kind}
    ...
    async def ping(self) -> ClientResponse:
        """Make the cheapest authenticated call Azure offers.
        ...
        """
        return await self.get(PING_PATH, params={"api-version": "2021-04-01", "$top": "1"})
