"""Flink's API, over the proxy, holding no credential.
...
Flink's authentication changed tomorrow, because the authentication is
...
from integrations.flink.schema import INTEGRATION, base_url

PING_PATH: Final = "/config"
LIST_TASKS_PATH: Final = "/jobs/overview"
LIST_FAILURES_PATH: Final = "/jobs/overview"
...
class FlinkClient(IntegrationClient):
    """Flink, reached through the credential proxy."""
    ...
    async def list_tasks(
        ...
        *,
        ...
        """Return what Flink holds for this request, bounded.
        ...
        """
        # Flink narrows this endpoint by other means; the argument stays in the
    ...
    async def ping(self) -> ClientResponse:
        """Make the cheapest authenticated call Flink offers.
