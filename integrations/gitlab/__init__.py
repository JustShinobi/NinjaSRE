"""GitLab: What landed in a GitLab project: the commits on a branch and the merge requests recently merged into it.
...
from integrations.gitlab.client import PAGINATION, GitlabClient
from integrations.gitlab.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.gitlab.verifier import PERMISSIONS, GitlabVerifier
