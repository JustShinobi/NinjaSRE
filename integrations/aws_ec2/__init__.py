"""AWS EC2: EC2 instance state for a region: how many instances are in which state, and the instances themselves with their type, zone, and launch time.
...
from integrations.aws_ec2.client import PAGINATION, AwsEc2Client
from integrations.aws_ec2.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.aws_ec2.verifier import PERMISSIONS, AwsEc2Verifier
...
DESCRIPTOR: Final = IntegrationDescriptor(
    ...
    schema=SCHEMA,
    rule=RULE,
    verifier=AwsEc2Verifier(),
    client_class=AwsEc2Client,
