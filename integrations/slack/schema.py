"""Slack's credential shape, hosts, and how its secret enters a request.
...
INTEGRATION: Final = "slack"


#: Every host Slack serves its API from. Exact names, no wildcards.
REGIONS: Final = RegionMap.single(INTEGRATION, host="slack.com", name="global")
