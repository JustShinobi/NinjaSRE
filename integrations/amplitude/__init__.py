"""Amplitude: Amplitude's product analytics: how user-facing event volume moved during a window, and which annotations mark what changed.
...
from integrations.amplitude.client import PAGINATION, AmplitudeClient
from integrations.amplitude.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.amplitude.verifier import PERMISSIONS, AmplitudeVerifier
...
DESCRIPTOR: Final = IntegrationDescriptor(
    ...
    schema=SCHEMA,
    rule=RULE,
    verifier=AmplitudeVerifier(),
    client_class=AmplitudeClient,
