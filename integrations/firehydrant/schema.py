"""FireHydrant's credential shape, hosts, and how its secret enters a request.
...
INTEGRATION: Final = "firehydrant"


#: Every host FireHydrant serves its API from. Exact names, no wildcards.
REGIONS: Final = RegionMap.single(INTEGRATION, host="api.firehydrant.io", name="global")
...
SCHEMA: Final = credential_schema(
    INTEGRATION,
    secret("token", "FireHydrant bot token or personal API key", min_length=8),
)
