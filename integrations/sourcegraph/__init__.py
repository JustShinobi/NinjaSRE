"""Sourcegraph: Code search across every repository at once: where a symbol, a string, or a configuration key actually appears.
...
from integrations.sourcegraph.client import PAGINATION, SourcegraphClient
from integrations.sourcegraph.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.sourcegraph.verifier import PERMISSIONS, SourcegraphVerifier
...
DESCRIPTOR: Final = IntegrationDescriptor(
    ...
    schema=SCHEMA,
    rule=RULE,
    verifier=SourcegraphVerifier(),
    client_class=SourcegraphClient,
