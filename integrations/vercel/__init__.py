"""Vercel: Vercel deployments: how the recent ones have gone for a project, and the ones that errored, which is usually the whole story for a frontend incident.
...
from integrations.vercel.client import PAGINATION, VercelClient
from integrations.vercel.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.vercel.verifier import PERMISSIONS, VercelVerifier
...
PROFILE: Final = IntegrationProfile(
    ...
    summary="Vercel deployments: how the recent ones have gone for a project, and the ones that errored, which is usually the whole story for a frontend incident.",
    regions=REGIONS,
