"""Argo CD: What Argo CD has actually applied: which applications are synced and healthy, and the ones that are not.
...
from integrations.argocd.client import PAGINATION, ArgocdClient
from integrations.argocd.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.argocd.verifier import PERMISSIONS, ArgocdVerifier
...
DESCRIPTOR: Final = IntegrationDescriptor(
    ...
    schema=SCHEMA,
    rule=RULE,
    verifier=ArgocdVerifier(),
    client_class=ArgocdClient,
