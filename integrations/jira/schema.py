"""Jira's credential shape, hosts, and how its secret enters a request.
...
SCHEMA: Final = credential_schema(
    ...
    public("project", "Default project key searches are scoped to"),
)
...
def rule_for(*hosts: str) -> InjectionRule:
    ...
    Jira is self-hosted, so nobody writing this file knows where it is.
...
def regions_for(**endpoints: str) -> RegionMap:
    ...
    ``regions_for(prod="jira.acme.example")``.
    """
