"""ClickUp: What ClickUp already tracks: the tasks in a list, in what status, and which are worth reading before another is created.
...
from integrations.clickup.client import PAGINATION, ClickupClient
from integrations.clickup.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.clickup.verifier import PERMISSIONS, ClickupVerifier
...
DESCRIPTOR: Final = IntegrationDescriptor(
    ...
    schema=SCHEMA,
    rule=RULE,
    verifier=ClickupVerifier(),
    client_class=ClickupClient,
