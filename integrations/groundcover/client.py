"""groundcover's API, over the proxy, holding no credential.
...
groundcover's authentication changed tomorrow, because the authentication is
...
from integrations.groundcover.schema import INTEGRATION, base_url

PING_PATH: Final = "/api/monitors/list"
QUERY_METRIC_PATH: Final = "/api/promql/query_range"
LIST_ALERTS_PATH: Final = "/api/monitors/list"
...
class GroundcoverClient(IntegrationClient):
    """groundcover, reached through the credential proxy."""
    ...
    async def query_metric(
        ...
        *,
        ...
        """Return what groundcover holds for this request, bounded.
