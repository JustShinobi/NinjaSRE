"""PostHog: PostHog's product analytics: how event volume moved during a window, and which feature flags are currently on.
...
from integrations.posthog.client import PAGINATION, PosthogClient
from integrations.posthog.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.posthog.verifier import PERMISSIONS, PosthogVerifier
...
DESCRIPTOR: Final = IntegrationDescriptor(
    ...
    schema=SCHEMA,
    rule=RULE,
    verifier=PosthogVerifier(),
    client_class=PosthogClient,
