"""Azure SQL's credential shape, hosts, and how its secret enters a request.
...
INTEGRATION: Final = "azure_sql"


#: Every host Azure SQL serves its API from. Exact names, no wildcards.
