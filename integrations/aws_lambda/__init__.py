"""AWS Lambda: The Lambda control plane: which functions exist, on which runtime and memory setting, and when each was last modified.
...
from integrations.aws_lambda.client import PAGINATION, AwsLambdaClient
from integrations.aws_lambda.schema import HOSTS, INTEGRATION, REGIONS, RULE, SCHEMA, base_url
from integrations.aws_lambda.verifier import PERMISSIONS, AwsLambdaVerifier
...
DESCRIPTOR: Final = IntegrationDescriptor(
    ...
    schema=SCHEMA,
    rule=RULE,
    verifier=AwsLambdaVerifier(),
    client_class=AwsLambdaClient,
