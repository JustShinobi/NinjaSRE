...
## Observação — a descoberta não resolve o nó do convidado
...
carrega `node=pve01` corretamente, então o dado existe; a descoberta é que não
o coleta. Provável causa do Achado 2.
