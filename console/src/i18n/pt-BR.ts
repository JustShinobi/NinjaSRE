...
export const PT_BR: Partial<Record<MessageKey, string>> = {
  ...
  'detectors.control.dryRunning': 'A verificar…',
  ...
  'detectors.control.enable': 'Activar',
  'detectors.control.enabling': 'A activar…',
  'detectors.control.disable': 'Desactivar',
  'detectors.control.disabling': 'A desactivar…',
  'detectors.control.cancel': 'Cancelar',
  'detectors.control.failed': 'A instalação recusou isto.',
  'detectors.control.unreachable': 'Não foi possível contactar a instalação.',
  ...
  'schedules.enabling': 'A activar…',
  'schedules.disable': 'Desactivar',
  'schedules.disabling': 'A desactivar…',
  'schedules.save': 'Guardar',
  'schedules.saving': 'A guardar…',
  'schedules.delete': 'Eliminar agendamento',
  ...
  'schedules.unreachable': 'Não foi possível contactar a instalação.',
