...
INVOCATIONS: dict[str, list[str]] = {
    ...
    "remediation.list": ["remediation", "list"],
    ...
    "remediation.problems": ["remediation", "problems"],
    "remediation.close-problem": [
        "remediation",
        "close-problem",
        "problem-0001",
        "--change",
    ...
    "remediation.suspensions": ["remediation", "suspensions"],
    "remediation.clear-suspension": [
        "remediation",
        "clear-suspension",
        "store-cove",
        "--reason",
        "restored by hand and healthy",
    ],
