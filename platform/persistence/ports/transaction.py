...
The bad one is a transaction handle threaded through every write — seventeen
...
organisation. Look through the seventeen ports and no method takes an ``org_id`` —
...
class UnitOfWork(Protocol):
    ...
    Seventeen properties and one method. The properties are the ports; the method
